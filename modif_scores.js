...
function editabled(item) {
        ...
        document.querySelectorAll(".tab_input")
            .forEach((element) => {
                    ...
                    if (cellule_old_item == element.id) {
                        ...
                        if (modif) {
                            ...
                            for (let index = 1; index < 96; index++) {
                                let recupScore = document.getElementById("score"+index).innerHTML;
                        ...
                        if(id_old.startsWith('equipe')){
                            ...
                            for (let index = 1; index < 17; index++) {
                                let recupEquipe = document.getElementById("equipe"+index).innerHTML;
